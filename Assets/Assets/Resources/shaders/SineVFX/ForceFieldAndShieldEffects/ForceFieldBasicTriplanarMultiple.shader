Shader "SineVFX/ForceFieldAndShieldEffects/ForceFieldBasicTriplanarMultiple" {
	Properties {
		...
		[Toggle] _CubemapReflectionEnabled ("Cubemap Reflection Enabled", Float) = 0
		...
		[Toggle] _RampFlip ("Ramp Flip", Float) = 0
		_MaskFresnelExp ("Mask Fresnel Exp", Range(0.2, 8)) = 4
		[Toggle] _MaskDepthFadeEnabled ("Mask Depth Fade Enabled", Float) = 1
